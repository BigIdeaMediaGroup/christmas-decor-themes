 ...
 */
function bimg_hide_if_no_cats( $field ) {
 ...
 * @param  CMB2_Field object $field      Field object
 */
function bimg_before_row_if_2( $field_args, $field ) {
...
function bimg_register_home_feature_metabox() {
	...
	$bimg_home_feature->add_field( array(
		...
		'desc'       => __( 'Set a title to appear in the feature box.', 'cmb2' ),
		'id'         => $prefix . 'title',
		'type'       => 'text',
    ) );
	...
	$bimg_home_feature->add_field( array(
		...
		'desc' => __( 'Provide additional text for the feature box.', 'cmb2' ),
		'id'   => $prefix . 'text',
		'type' => 'textarea',
	) );
}
...
function bimg_register_home_services_metabox() {
	...
	$bimg_home_services->add_field( array(
		'name'       => __( 'Column 1 Title', 'cmb2' ),
		'desc'       => __( 'Set a title for the first column.', 'cmb2' ),
		'id'         => $prefix . 'col1_title',
		'type'       => 'text',
    ) );

	$bimg_home_services->add_field( array(
		'name' => __( 'Column 1 Image', 'cmb2' ),
	...
	$bimg_home_services->add_field( array(
		'name' => __( 'Column 1 Text', 'cmb2' ),
		'desc' => __( 'Provide a brief description for the first column.', 'cmb2' ),
		'id'   => $prefix . 'col1_text',
		'type' => 'textarea',
	) );

	$bimg_home_services->add_field( array(
		'name'       => __( 'Column 2 Title', 'cmb2' ),
		'desc'       => __( 'Set a title for the second column.', 'cmb2' ),
		'id'         => $prefix . 'col2_title',
		'type'       => 'text',
    ) );

	$bimg_home_services->add_field( array(
		'name' => __( 'Column 2 Image', 'cmb2' ),
		'desc' => __( 'Upload an image or enter a URL.', 'cmb2' ),
	...
	$bimg_home_services->add_field( array(
		'name' => __( 'Column 2 Text', 'cmb2' ),
		'desc' => __( 'Provide a brief description for the second column.', 'cmb2' ),
		'id'   => $prefix . 'col2_text',
		'type' => 'textarea',
	) );

	$bimg_home_services->add_field( array(
		'name'       => __( 'Column 3 Title', 'cmb2' ),
		'desc'       => __( 'Set a title for the third column.', 'cmb2' ),
		'id'         => $prefix . 'col3_title',
		'type'       => 'text',
    ) );

	$bimg_home_services->add_field( array(
		'name'  => __( 'Column 3 Video', 'cmb2' ),
		'desc'  => __( 'Enter a YouTube Video ID.', 'cmb2' ),
		'id'    => $prefix . 'col3_embed',
		'type'  => 'text',
	...
	$bimg_home_services->add_field( array(
		'name' => __( 'Column 3 Text', 'cmb2' ),
		'desc' => __( 'Provide a brief description for the third column.', 'cmb2' ),
		'id'   => $prefix . 'col3_text',
		'type' => 'textarea',
	) );
}
...
function bimg_register_home_list_metabox() {
	...
	$bimg_home_list->add_field( array(
		'name'    => __( 'Why Choose Us?', 'cmb2' ),
		'desc'    => __( 'Enter a bullet list.', 'cmb2' ),
		'id'      => $prefix . 'list',
		'type'    => 'wysiwyg',
...
add_action( 'cmb2_init', 'bimg_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_init' hook.
 */
function bimg_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'bimg_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'bimg_before_row_if_2', // callback
...
add_action( 'cmb2_init', 'bimg_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function bimg_register_about_page_metabox() {
...
add_action( 'cmb2_init', 'bimg_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function bimg_register_repeatable_group_field_metabox() {
...
add_action( 'cmb2_init', 'bimg_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function bimg_register_user_profile_metabox() {
...
add_action( 'cmb2_init', 'bimg_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function bimg_register_theme_options_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$option_key = '_bimg_theme_options';
